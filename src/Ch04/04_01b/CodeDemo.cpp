...
int main(){
    ...
    std::cout << "Level difficulties are as follows:" << std::endl;
    std::cout << "Level 1: " << levelDifficulty[0] << std::endl;
    std::cout << "Level 2: " << levelDifficulty[1] << " enemies" << std::endl;
    std::cout << "Level 3: " << levelDifficulty[2] << " enemies" << std::endl;
    std::cout << "Level 4: " << levelDifficulty[3] << " enemies" << std::endl;
